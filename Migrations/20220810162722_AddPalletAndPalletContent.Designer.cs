...
namespace WarehouseManagerAPI.Migrations
{
    ...
    [Migration("20220810162722_AddPalletAndPalletContent")]
    partial class AddPalletAndPalletContent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WarehouseManagerAPI.Entities.Pallet", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WarehouseManagerAPI.Entities.PalletContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WarehouseManagerAPI.Entities.Storage", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WarehouseManagerAPI.Entities.StorageContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WarehouseManagerAPI.Entities.PalletContent", b =>
                {
                    b.HasOne("WarehouseManagerAPI.Entities.Pallet", "Pallet")
            ...
            modelBuilder.Entity("WarehouseManagerAPI.Entities.StorageContent", b =>
                {
                    ...
                    b.HasOne("WarehouseManagerAPI.Entities.Storage", "Storage")
                        .WithMany("StorageContent")
